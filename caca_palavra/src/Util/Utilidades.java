...
/**
 * Classe com mÈtodos estÈticos para auxiliar o desenvolmento de forma geral
 * 
...
public class Utilidades {
	...
	private static ALogger						log			= ALogger.getLogger(Utilidades.class);
	...
	public static String brakeLineChar(String str, int size) {
		...
		List<String> lines =  Utilidades.brakeLine(str, size);
	...
	/**
	 * Consulta o IP da estaÁ„o
	 * 
	 * @return Uma {@link String} com o IP da estaÁ„o
	 */
	...
	/**
	/**
	 * MÈtodo NVL, mÈtodo retorna segundo par‚metro, caso o primeiro esteja nulo
	 * 
	 * @param <T>
	 *            <T>
	 * @param param1
	...
	public static BigDecimal stringToBigDecimal(String vlr) throws Exception {
		...
		// verifica se h· mais de um ponto ou se h· alguma vÌrgula apÛs o ponto
