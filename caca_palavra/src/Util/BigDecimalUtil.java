...
public class BigDecimalUtil {
	...
	/**
	 * Contexto mateático que ï¿½ construï¿½do com {@link #defaultPrecision} e {@link #defaultRounding}
	 */
	private static MathContext		defaultContext;
	
	static {
		// Atribuiï¿½ï¿½o do valores iniciais dos atributos
		defaultPrecision = 15;
	...
	/**
	 * Atribuiçãoo da precisão, quantidade de casas decimais apÃ¡s a virgula, que
	 * serÃ¡ usada nas operaçÃµes matemÃ¡ticas
	 * 
	 ...
	 *            Método de arredondamento que serÃ¡ usado nas operaçÃµes
	 *            MatemÃ¡ticas
	 * 
	 * @see RoundingMode
	 */
	...
	public static BigDecimal sum(BigDecimal v1, BigDecimal v2) {
		// Se ï¿½ nulo considera como Zero (0)
		if (v1 == null)
			v1 = ZERO;
	 ...
	 * @return um {@link BigDecimal} com o resultado da operaï¿½ï¿½o.
	 */
	public static BigDecimal sum(BigDecimal... vlrs) {
		BigDecimal result = ZERO;
		
		for (int i = 0; i < vlrs.length; i++) {
			result = result.add(Utilidades.nvl(vlrs[i], ZERO));
		}
	...
	/**
	 * Efetua a divisï¿½o do valor por 100
	 * 
	 * @param v1
	 *            Valor para divisao
	 * @param scale
	 ...
	 * 
	 * @param v1
	 *            Valor 1, se o valor informado for <code>null</code> serÃ¡
	 ...
	 * informado no segundo parÃ¢metro
	 * 
	 * @param v1
	 *            Valor 1
	 * @param v2
	 ...
	 * o valor informado no segundo parÃ¢metro
	 * 
	 * @param v1
	 *            Valor 1
	 * @param v2
